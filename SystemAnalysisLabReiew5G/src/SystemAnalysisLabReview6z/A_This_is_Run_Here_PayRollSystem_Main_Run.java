...
/*            JOptionPane.showMessageDialog(null, "===========================================================\n" +
    ...
    private void setOutputDataMenu() {// private JMenuItem OutputPayStubI, ListAllEmployeePayStubI;
        ...
        JMenuItem mntmNewMenuItem = new JMenuItem("List all employsee");
        mntmNewMenuItem.addMouseListener(new MouseAdapter() {
        	@Override
        	public void mousePressed(MouseEvent e) {
        		

        		//alll list employees begin:
        		
        		;
				try {
					ListAllEmployee  theListAllEmployee  = new ListAllEmployee ();
				
	        		theListAllEmployee .setVisible(true);
