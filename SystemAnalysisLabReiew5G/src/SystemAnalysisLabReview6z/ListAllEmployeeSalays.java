...
public class ListAllEmployeeSalays extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					 ListAllEmployeeSalays frame = new ListAllEmployeeSalays();
	 ...
	 */
	public ListAllEmployeeSalays() throws FileNotFoundException, IOException {
	...
	public static void connecttoOracle(String username, String password) {
        ...
        //or:
			...
			Statement sH = c.createStatement();
