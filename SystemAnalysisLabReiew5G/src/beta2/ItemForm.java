...
public class ItemForm extends JFrame {
	...
	public void addItem(){
		...
		ItemBean1.setItemPay_no(Integer.parseInt(ItemPayNo_textField.getText()));
		ItemBean1.setItemPay_title(ItemPayTitle_textField.getText());
		ItemBean1.setItemPay_rate(Double.parseDouble(ItemPayRate_textField.getText()));
	
		
		ItemBeanAction eA1=new ItemBeanAction();
	...
	public void searchItem(){
		...
		if((ItemPayNo_textField.getText().trim()).equals("")){
			...
			ItemBeanAction eA1=new ItemBeanAction();
			ItemBean searchResult=new ItemBean();
			searchResult=eA1.search(sql);
			ItemPayTitle_textField.setText(searchResult.getItemPay_title());
			ItemPayRate_textField.setText(""+searchResult.getItemPay_rate());
	...
	public void updateItemInfo(){
		...
		ItemBeanAction ed1=new ItemBeanAction();
