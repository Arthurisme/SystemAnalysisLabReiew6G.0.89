...
public class TaxRate {
    ...
    private ArrayList<ItemBean> deductionList=new ArrayList<ItemBean>();
    ...
    public ArrayList<ItemBean> getDeductionList(){
    	...
    	try {
            ...
            while(rs.next()){
            	currentItemBean=new ItemBean();
            	currentItemBean.setItemPay_no(rs.getInt("ItemPay_No"));
            	currentItemBean.setItemPay_title(rs.getString("ItemPay_title"));
            	currentItemBean.setItemPay_rate(rs.getDouble("ItemPay_rate"));
            	deductionList.add(currentItemBean);
