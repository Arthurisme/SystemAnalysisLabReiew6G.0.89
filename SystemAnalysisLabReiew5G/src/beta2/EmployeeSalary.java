...
public class EmployeeSalary {
    ...
    private EmployeeInfoBean employeeInfoBean1=new EmployeeInfoBean();
    ...
    private ArrayList<ItemBean> deductionList;
    ...
    public ArrayList<ItemBean> getDeductionList(){
    	return deductionList;
    }
    
    public void set_EmployeeInfo(EmployeeInfoBean employeeInfoBean2){
    	this.employeeInfoBean1=employeeInfoBean2;
    }
...
/*        this.FedTax_Deduction=this.Total_income*TaxRate.FederalTax_rate;
        ...
        deductionList=new ArrayList<ItemBean>();
        ...
        for(int i=0;i<deductionList.size();i++){
        	current_deductionRate=deductionList.get(i).getItemPay_rate();
        	if(deductionList.get(i).getItemPay_no()==100 || deductionList.get(i).getItemPay_no()==101){
        		if(deductionList.get(i).getItemPay_no()==100){
    ...
    public void CalculateNetIncome(){
        ...
        for(int i=0;i<deductionList.size();i++){
        	...
        	if(deductionList.get(i).getItemPay_no()==101){
        ...
        //check the same record exist in the table of EmpPayDetail(correct: not exist)	
    		...
    		temp_sql="select * from EmpPayDetails where EmployeeId="+this.employeeInfoBean1.getEmp_id()
    				+"and ItemPay_No="+deductionList.get(i).getItemPay_no()
    		...
    		sql="insert into EmpPayDetails values("+this.employeeInfoBean1.getEmp_id()
    				+","+deductionList.get(i).getItemPay_no()
    				+","+this.Number_workedHour
    				+","+this.Hourly_rate
    				+","+deductionList.get(i).getItemPay_rate()
